...
let halfsuccess = ServerResponse.result("6:00am")
let failure = ServerResponse.failure("Out of cheese.")

switch success {
    case let .result(sunrise, sunset):
        print("Sunrise is at \(sunrise) and sunset is at \(sunset).")
    case let .halfsuccess(startTime):
        print("Sunrise is at \(startTime) but we're not sure about sunset given this clpudy weather")
